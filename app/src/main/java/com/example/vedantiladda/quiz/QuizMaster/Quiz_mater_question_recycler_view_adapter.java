...
import com.example.vedantiladda.quiz.QuizMaster.QuizMasterPojo.ContestQuestionDTO;
import com.example.vedantiladda.quiz.QuizMaster.QuizMasterPojo.QuestionDTO;
...
public class Quiz_mater_question_recycler_view_adapter extends RecyclerView.Adapter<Quiz_mater_question_recycler_view_adapter.View_Holder> {
    ...
    @NonNull
    @Override
    public Quiz_mater_question_recycler_view_adapter.View_Holder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        Quiz_mater_question_recycler_view_adapter.View_Holder holder =new Quiz_mater_question_recycler_view_adapter.View_Holder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final Quiz_mater_question_recycler_view_adapter.View_Holder holder, final int position) {
