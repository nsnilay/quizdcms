...
public class QuizMaster_recycler_view_adapter extends RecyclerView.Adapter<QuizMaster_recycler_view_adapter.View_Holder> {
    ...
    Context context;
    QuizMaster_recycler_view_adapter.IPostsAdapterCommunicatorDynamicContests iPostsAdapterCommunicatorDynamicContests;
    ...
    @NonNull
    @Override
    public QuizMaster_recycler_view_adapter.View_Holder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_quiz_master_recycler_view_adapter,parent,false);
        QuizMaster_recycler_view_adapter.View_Holder holder =new QuizMaster_recycler_view_adapter.View_Holder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull QuizMaster_recycler_view_adapter.View_Holder holder, final int position) {
